...
*Note: A common Ground (GND) is **MANDATORY** for the UART to function correctly at 500kbps without data corruption.*
...
---
*Credit to the OpenStickCommunity for the foundational GP2040-CE architecture.*
